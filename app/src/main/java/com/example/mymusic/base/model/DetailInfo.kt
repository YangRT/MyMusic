...
data class Playlist(val id: Long, val createTime: Long, val updateTime: Long,val coverImgUrl: String, val playCount: Long,val shareCount: Int, val commentCount: Int, val subscribedCount: Int, val description: String, val name: String, val tracks: List<Track>, val subscribed: Boolean?)
