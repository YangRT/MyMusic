...
data class HotSong(val rtUrls: List<String>, val no: Int, val fee: Int, val alia: List<String>, val name: String, val privilege: Privilege, val id: Long, val ar: List<Ar>, val al: AI, val dt: Long)
