...
class SearchSongsRepository(var word: String): BaseMvvmRepository<List<SearchSong>>(false,"SearchSongs",null) {
    ...
    public suspend fun search(word: String): BaseResult<List<SearchSong>> {
        this.word = word
        return load()
    }
}