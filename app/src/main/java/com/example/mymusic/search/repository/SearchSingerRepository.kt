...
class SearchSingerRepository(var word: String): BaseMvvmRepository<List<SearchArtist>>(false,"SearchSinger",null) {
    ...
    public suspend fun search(word: String): BaseResult<List<SearchArtist>> {
        this.word = word
        return load()
    }
}